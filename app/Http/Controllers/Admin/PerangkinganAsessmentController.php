...
class PerangkinganAsessmentController extends Controller
{
    public function index()
    {
        ...
        $skorAkhirSekolah = $skorAkhirSekolah->sortByDesc('skor')->values(); // .values() untuk reset keys

        return view('admin.perangkingan-asessment.index', compact('sekolahs', 'kriterias', 'asessments', 'skorAkhirSekolah'));
    }
    ...
    public function pdf()
    {
        ...
        // Download PDF
        return $pdf->download('skor_akhir.pdf');
    }
}
